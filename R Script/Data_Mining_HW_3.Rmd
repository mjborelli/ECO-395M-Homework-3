...
```
There are 1176 accounts in this cluster, or approximately `r round(100*C2_obs / social_obs, 2)`% of our sample. Accounts in this cluster have higher than average frequencise of news, politics, automotive, computers, and travel content. This is a bit of a broader category of people in various working professions, with a cross-sectional interest in news and politics. Since these people are generally using their twitter accounts for their work interests, advertising to these accounts should focus on how NutrientH20 products can improve work performance and focus.
