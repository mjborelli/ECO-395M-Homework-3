...
for (i in 1:5){
        cumul_RMSE = 0
        for(j in 1:10) {
                        forest1 = randomForest(Rent ~ size + leasing_rate + stories + age + renovated + class_a + class_b + LEED + Energystar + net + amenities + total_dd_07 + Precipitation + Gas_Costs + Electricity_Costs, mtry=1, nTree=i*50, data=green_train)
